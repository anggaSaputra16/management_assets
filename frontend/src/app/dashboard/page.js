...
export default function DashboardPage() {
    ...
    return (
      <DashboardLayout>
        <div className="glass-card p-6 text-center">
          ...
          <h2 className="text-xl font-semibold text-[#111] mb-2">Failed to Load Dashboard</h2>
    ...
    return (
      <DashboardLayout>
        <div className="glass-card p-6 text-center">
          ...
          <h2 className="text-xl font-semibold text-[#111] mb-2">No Data Available</h2>
          <p className="text-[#333]">Start by adding assets to your system.</p>
        </div>
      </DashboardLayout>
    )
  }
      ...
      <div className="space-y-6">
        ...
        <div className="glass-card">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right text-[#333] text-sm">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="glass-card">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-xl font-semibold text-[#111]">Stock Assets</h3>
            ...
            <div className="grid grid-cols-2 gap-6 mb-6">
              <div className="text-center">
                <div className="text-4xl font-bold text-[#111] mb-1">
                  {stats?.overview?.totalAssets || 0}
                </div>
                <div className="text-[#333] text-sm">Total Stock</div>
              </div>
              <div className="text-center">
                <div className="text-4xl font-bold text-[#111] mb-1">
                  {stats?.assets?.byStatus?.AVAILABLE || 0}
                </div>
                <div className="text-[#333] text-sm">Available Stock</div>
              </div>
            </div>
        ...
        <div className="glass-card">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-xl font-semibold text-[#111]">Available Assets Detail</h3>
            <Link 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="glass-button p-6 rounded-xl hover:scale-105 transition-transform">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <Package className="h-8 w-8 text-[#111] mb-2" />
                  <h4 className="text-lg font-semibold text-[#111]">Hardware Assets</h4>
                </div>
                <div className="text-right">
                  <div className="text-3xl font-bold text-[#111]">
                    {stats?.assets?.byStatus?.AVAILABLE || 0}
                  </div>
                  <div className="text-[#333] text-sm">Ready to Use</div>
                </div>
              </div>
              ...
              <button 
                ...
                className="w-full mt-4 glass-button py-2 rounded-lg text-[#111] font-medium hover:scale-105 transition-transform"
              >
                Browse Hardware
              </button>
            </div>
            ...
            <div className="glass-button p-6 rounded-xl hover:scale-105 transition-transform">
              <div className="flex items-center justify-between mb-4">
                <div>
                  <Settings className="h-8 w-8 text-[#111] mb-2" />
                  <h4 className="text-lg font-semibold text-[#111]">Software Assets</h4>
                </div>
                <div className="text-right">
                  <div className="text-3xl font-bold text-[#111]">
                    {stats?.software?.available || 0}
                  </div>
                  <div className="text-[#333] text-sm">Licenses Available</div>
                </div>
              </div>
              <div className="space-y-2 text-sm">
                <div className="flex justify-between text-[#333]">
  ...
  {/* Asset Categories & Locations */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Top Categories */}
          <div className="glass-card p-6">
            <h3 className="text-xl font-semibold text-[#111] mb-6">Top Asset Categories</h3>
          ...
          {/* Top Locations */}
          <div className="glass-card p-6">
            <h3 className="text-xl font-semibold text-[#111] mb-6">Top Asset Locations</h3>
            <div className="space-y-4">
          ...
          <div className="glass-card p-6">
            ...
            <div className="grid grid-cols-2 gap-4 mb-6">
              <div className="glass-button p-4 rounded-xl text-center">
                ...
                <div className="text-[#333] text-sm">Upcoming</div>
              </div>
              <div className="glass-button p-4 rounded-xl text-center">
                <div className="text-3xl font-bold text-[#111] mb-1">
                  {stats?.maintenance?.overdue || 0}
                </div>
                <div className="text-[#333] text-sm">Overdue</div>
              </div>
            </div>

            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-[#111]">Total Cost (This Month)</span>
                <span className="text-[#111] font-bold">
                  ${(stats?.maintenance?.totalCost || 0).toLocaleString()}
                </span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-[#111]">Total Maintenance</span>
                <span className="text-[#111] font-bold">{stats?.maintenance?.total || 0}</span>
              </div>
              <div className="flex items-center justify-between">
        ...
        <div className="glass-card p-6">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-xl font-semibold text-[#111]">Top Companies by Assets</h3>
        ...
        <div className="glass-card p-6">
          <h3 className="text-xl font-semibold text-[#111] mb-6">Asset Status Overview</h3>
            ...
            {Object.entries(stats?.assets?.byStatus || {}).map(([status, count]) => {
              ...
              return (
                <div key={status} className="glass-button p-4 rounded-xl text-center">
                  ...
                  <div className="text-2xl font-bold text-[#111] mb-1">{count}</div>
                  <div className="text-[#333] text-sm mb-1">{config.label}</div>
